...
Furthermore, it is important to note here that R's __table()__ function is treating zeroes as __*negative*__ outcomes while 1's are treated as __*positive*__ values. This fact will become relevant when we compare the output of the functions we build here against the output of R's __caret__ package.
